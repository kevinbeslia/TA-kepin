     ...
     <div class="row">
        ...
        <div class="card shadow mt-3 mb-3">
            ...
            <script>
                ...
                var data_nilai = [<?php while ($row = mysqli_fetch_array($sql)) {echo '"' . $row['hasil'] . '",';}?>];
                var data_alternatif = [<?php mysqli_data_seek( $sql, 0 ); while ($row = mysqli_fetch_array($sql)) {echo '"' . $row['nama'] . '",';}?>];
        ...
        <div class="card shadow mt-3 mb-3">
            ...
            ?>
            <script>
                var data_alternatif1 = [<?php mysqli_data_seek( $query, 0 ); while ($row = mysqli_fetch_array($query)) {echo '"'.$row['nama'].'",';}?>]
                var c1 = [
                    <?php 
                ...
                var barChart = new Chart(ctx, {
                    ...
                    data: {
                        ...
                        {
                            label: 'Pendapatan Bersih Perbulan',
                        ...
                        },
                        {
                            ...
                            borderColor: 'rgba(200, 200, 200, 0.75)',
                            hoverBackgroundColor: 'rgba(124, 252, 0, 1)',
                            hoverBorderColor: 'rgba(124, 252, 0, 1)',
                            data: c4
                        },
                        {
                            label: 'Lamanya Bekerja',
