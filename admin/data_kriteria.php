...
<?php 
  ...
  if (isset($_POST['tambah'])) {
    ...
    if (mysqli_num_rows($checkDuplicateResult) > 0) {
        ...
        $save = mysqli_query($konek, "INSERT INTO tbl_kriteria VALUES ('', '$nama_kriteria', '$jenis_kriteria', '$bobot')");
...
function removeEditSuccess() {
    ...
    window.location.href = newUrl;
		...
		<a href="sub_kriteria.php" class="btn btn-sm btn-primary mb-3"> > Sub Kriteria</a>
        <div class="table-responsive">
              ...
              <td>
                <a href="edit_kriteria.php?id=<?php echo $array['id_kriteria']; ?>"><i class="btn btn-info btn-sm"><span class="fas fa-edit"></span></i></a>
					...
					<td align="center">
                <a href="hapus_kriteria.php?id=<?php echo $array['id_kriteria']; ?>&page=<?php echo $currentPage; ?>"><i class="btn btn-danger btn-sm" onclick="return confirm('Apakah Data Kriteria ini akan dihapus?')"><span class="fas fa-trash"></span></i></a></td>		
						</tr>
					</tbody>
					<?php 
					} 
