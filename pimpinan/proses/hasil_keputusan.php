...
if (isset($_GET['id_hasil'])) {
	...
	$qqq = mysqli_query($konek, "UPDATE tbl_hasil SET persetujuan='1' WHERE id_hasil=$id_hasil");
}
?>
							...
							?>
								<tr style="color: #355E3B">
									...
									<td style="font-size: 15px;  font-weight: bold; vertical-align: middle;" align="center" valign="bottom">
										...
										<td style="font-size: 15px; text-align: center ; vertical-align: middle;"><?php 
									if ($dd['persetujuan']=='0') {
										echo '<a class="btn btn-primary btn-sm" href="hasil_keputusan.php?idp='.$dd['id_periode'].'&id_hasil='. $dd['id_hasil'].'">Setujui</a>';
									}else {
										echo "Disetujui";
									}
									 ?>
