...
<div class="container-fluid">
	...
	<div class="card shadow mt-3 mb-3">
		...
		<div class="card-body">
			...
			$totalData = mysqli_num_rows(mysqli_query($konek, "SELECT a.* FROM tbl_penilaian a JOIN tbl_alternatif b ON a.id_alternatif = b.id_alternatif WHERE a.id_periode = '$idp' GROUP BY a.id_alternatif"));
