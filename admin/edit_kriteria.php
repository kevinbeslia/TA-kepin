	...
	<div class="col-lg-12">
		...
		<div class="card shadow mt-3 mb-3">
			<div class="card-header d-flex justify-content-between">
				...
				<a href="data_kriteria.php?idp=<?= $dd['id_periode'] ?>" class="btn btn-sm btn-danger">
					< Kembali</a>
			</div>
			<div class="card-body">
				<form action="" method="POST">
					...
					<div class="form-group">
						...
						<select name="jenis" class="form-control mb-2" required="">
							<option value="Benefit" <?= ($dd['jenis_kriteria'] == 'Benefit') ? 'selected' : '' ?>>Benefit</option>
							<option value="Cost" <?= ($dd['jenis_kriteria'] == 'Cost') ? 'selected' : '' ?>>Cost</option>
						</select>
					</div>
					<div class="form-group">
...
if (isset($_POST['edit'])) {
	...
	if ($totalBobot > 1) {
		echo "<script language=javascript>
                ...
                window.location='data_kriteria.php?idp=" . $dd['id_periode'] . "&edit_success=false';
              </script>";
		exit;
	}
	...
	if ($totalBobot < 1) {
		echo "<script language=javascript>
                ...
                window.location='data_kriteria.php?idp=" . $dd['id_periode'] . "&edit_success=true';
              </script>";
