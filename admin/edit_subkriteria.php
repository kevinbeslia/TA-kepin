	...
	<div class="col-lg-12">
		...
		<div class="card shadow mt-4">
			<div class="col card-header d-flex justify-content-between">
				...
				<a href="sub_kriteria.php?idp=<?= $id_periode ?>&page=<?= $page ?>" class="btn btn-sm btn-danger">
					< Kembali</a>
			</div>
			<div class="card-body">
...
if (isset($_POST['edit'])) {
	...
	if (mysqli_num_rows($checkQuery) > 0) {
		echo "<script language=javascript>
            ...
            window.location='sub_kriteria.php?idp=$id_periode&page=$currentPage&edit_success=false';
            </script>";
		exit();
	}
	...
	if ($update) {
		echo "<script language=javascript>
				window.location='sub_kriteria.php?idp=$id_periode&page=$currentPage&edit_success=true';
				</script>";
	} else {
		echo "<script language=javascript>
				window.location='sub_kriteria.php?idp=$id_periode&page=$currentPage&edit_success=false';
