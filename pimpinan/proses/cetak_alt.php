...
<body onload="window.print();">
	...
	<center>
		<div class="container">
			<p><img src="style/logo2.png" width="150px" class="mt-3"></p>
			<p style="font-size:30px;padding:0px;margin-bottom:-15px;"><b>RUMAH TAHANAN NEGARA KLAS IIB PADANG</b></p>
			<p class="mt-3" style="font-size:23px;padding:0px;margin-bottom:-12px;"><b>REKOMENDASI KELAYAKAN NARAPIDANA DALAM PENERIMAAN REMISI</b></p></p>
			<br>
			<hr>
	</center>
			...
			<tr>
				<thead>
						<tr style="background-color: #529dff; color: #000000; border: 2px ;border-color: green" align="center">
							...
							<th rowspan="2" style="vertical-align: middle; border: 1px solid black;">Persetujuan </th>
						</tr>
