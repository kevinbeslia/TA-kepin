...
?>
        ...
        <a href="data_kriteria.php" class="btn btn-sm btn-primary mb-3"> < Kriteria</a>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            <tr style="color: #355E3B">
              ...
              <td align="center">
                <a href="edit_subkriteria.php?id=<?php echo $array['id_subkriteria']; ?>&page=<?php echo $currentPage; ?>"><i class="btn btn-info btn-sm"><span class="fas fa-edit"></span></i></a></td>

              <td align="center">
                <a href="hapus_subkriteria.php?id=<?php echo $array['id_subkriteria']; ?>&page=<?php echo $currentPage; ?>"><i class="btn btn-danger btn-sm" onclick="return confirm('Apakah Data Sub Kriteria ini akan dihapus?')"><span class="fas fa-trash"></span></i></a></td>
            </tr>
          </tbody>
          <?php 
          } 
